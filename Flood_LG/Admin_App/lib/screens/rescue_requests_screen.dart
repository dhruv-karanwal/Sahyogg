...
import '../controllers/sos_service.dart';
...
class _RescueRequestsScreenState extends State<RescueRequestsScreen> {
      ...
      body: Container(
        ...
        child: SafeArea(
          child: StreamBuilder<QuerySnapshot>(
            stream: SOSService().allSOSStream,
  ...
  Future<void> _acknowledgeRequest(String id, String currentStatus) async {
    if (currentStatus == 'ACKNOWLEDGED') return;
    
    try {
      await SOSService().updateSOSStatus(id, 'ACKNOWLEDGED');
      if (mounted) {
                 ...
                 if (isPending) ...[
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () => _acknowledgeRequest(req['id'], req['status']),
                      style: ElevatedButton.styleFrom(
